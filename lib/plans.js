...
const PLANS = {
    free: {
        ...
        features: ['inventory_management', 'marketplace', 'pricing_lookup', 'bulk_import', 'shipping_labels'],
        sheets_sync: false,
        ebay_sync: false,
        multi_user: false,
        analytics: false,
    ...
    pro: {
        ...
        shipping_surcharge: 0.50,
        features: ['inventory_management', 'marketplace', 'pricing_lookup', 'sheets_sync', 'bulk_import', 'buylist', 'analytics', 'grading_tracker'],
        sheets_sync: true,
        ebay_sync: false,
        multi_user: false,
        analytics: true,
    ...
    business: {
        ...
        card_limit: 25000,
        platform_fee_percent: 1.5,
        features: ['inventory_management', 'marketplace', 'pricing_lookup', 'sheets_sync', 'ebay_sync', 'ebay_auto_relist', 'tcgplayer_sync', 'bulk_import', 'buylist', 'analytics', 'multi_user', 'grading_tracker', 'shipping_labels'],
        sheets_sync: true,
        ebay_sync: true,
        multi_user: true,
        analytics: true,
    ...
    shop: {
        ...
        features: ['inventory_management', 'marketplace', 'pricing_lookup', 'sheets_sync', 'ebay_sync', 'ebay_auto_relist', 'tcgplayer_sync', 'bulk_import', 'buylist', 'analytics', 'multi_user', 'grading_tracker', 'shipping_labels', 'api_access', 'priority_support'],
        sheets_sync: true,
        ebay_sync: true,
        multi_user: true,
        analytics: true,
...
function getShippingSurcharge(planId) {
    const plan = getPlan(planId);
    return plan.shipping_surcharge || 0;
}
