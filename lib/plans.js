...
const PLANS = {
    ...
    business: {
        ...
        card_limit: 25000,
        platform_fee_percent: 1.5,
        features: ['inventory_management', 'marketplace', 'pricing_lookup', 'sheets_sync', 'ebay_sync', 'ebay_auto_relist', 'bulk_import', 'buylist', 'analytics', 'multi_user', 'grading_tracker'],
        sheets_sync: true,
        ebay_sync: true,
        multi_user: true,
        analytics: true,
    ...
    shop: {
        ...
        platform_fee_percent: 1.5,
        features: ['inventory_management', 'marketplace', 'pricing_lookup', 'sheets_sync', 'ebay_sync', 'ebay_auto_relist', 'bulk_import', 'buylist', 'analytics', 'multi_user', 'grading_tracker', 'api_access', 'priority_support'],
        sheets_sync: true,
        ebay_sync: true,
        multi_user: true,
        analytics: true,
