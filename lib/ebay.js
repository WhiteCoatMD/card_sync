...
function mapConditionId(condition) {
    // Trading Cards (183454) valid: 2750=Graded, 3000=Used, 4000=Ungraded
    const map = {
        mint: '4000',           // Ungraded
        near_mint: '4000',      // Ungraded
        lightly_played: '3000', // Used
        moderately_played: '3000',
        heavily_played: '3000',
        damaged: '3000',
    };
    return map[condition] || '4000';
}
